...
CONSTRAINT `FK_PAGE_site_id` FOREIGN KEY (`site_id`) REFERENCES `site` (`id`) ON DELETE CASCADE
...
CONSTRAINT `FK_LEMMA_site_id` FOREIGN KEY (`site_id`) REFERENCES `site` (`id`) ON DELETE CASCADE
 );
...
CONSTRAINT `FK_INDEX_page_id` FOREIGN KEY (`page_id`) REFERENCES `page` (`id`) ON DELETE CASCADE,
KEY `FK_INDEX_lemma_id_idx` (`lemma_id`),
CONSTRAINT `FK_INDEX_lemma_id` FOREIGN KEY (`lemma_id`) REFERENCES `lemma` (`id`) ON DELETE CASCADE
);
